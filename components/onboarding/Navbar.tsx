  ...
  return (
    <nav className={`navbar${onDark ? ' navbar--dark' : ''}`}>
      <a className="nav-brand" href="#">
        ...
        />
        <div>
          <div className="nav-name">Joaquín Merlos</div>
          <div className="nav-handle">@merlosjoa</div>
        </div>
      </a>

      <div className="nav-social">
        <a
          href="https://instagram.com/merlosjoa"
          className="soc-ig"
          target="_blank"
        ...
        <a
          href="https://www.tiktok.com/@merlosjoa"
          className="soc-tt"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="TikTok"
        ...
        <a
          href="https://www.linkedin.com/in/joaquinmerlos/"
          className="soc-li"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="LinkedIn"
        ...
        <a
          href="https://www.youtube.com/@merlosjoa"
          className="soc-yt"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="YouTube"
